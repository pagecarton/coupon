    ...
    protected function createList()
    {
		...
		(
			array(
                    ...
                    'start' => array( 'field' => 'start_date', 'value' =>  '%FIELD%', 'filter' =>  'Ayoola_Filter_Time' ),                     
                    'expires' => array( 'field' => 'expiry_date', 'value' =>  '%FIELD%', 'filter' =>  'Ayoola_Filter_Time' ),                     
                    'stock' => array( 'field' => 'maximum_usage', 'value' =>  '%FIELD%', 'filter' =>  'Ayoola_Filter_Int' ),                     
                    'clicks' => array( 'field' => 'applied_count', 'value' =>  '%FIELD%', 'filter' =>  'Ayoola_Filter_Int' ),                     
                    'buys' => array( 'field' => 'usage', 'value' =>  '%FIELD%', 'filter' =>  'Ayoola_Filter_Int' ), 
